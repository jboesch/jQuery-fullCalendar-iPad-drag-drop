...
(function($){
    ...
    $.fn.fullCalendar = function(options)
    {
        ...
        {
            if(typeof(options.events) == 'string' || $.isFunction(options.events))
            {
            ...
            {
                $el.fullCalendarSetupTouchDraggable();
                return _old_viewDisplay.apply(this, arguments);
            }
            ...
            {
                // This ONLY gets called if we're loading static events as an array
                // If you're loading events via ajax, this gets called automatically
                $el.fullCalendarSetupTouchDraggable();
            }
