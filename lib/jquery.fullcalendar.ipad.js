...
(function($){
    ...
    $.fullCalendarSetupDraggable = function()
    {
    ...
    $.fn.fullCalendar = function(options)
    {
        ...
        if(isTouchDevice() && typeof options == 'object')
        {
            // Hijack the loading method
            ...
            return _old_fc.call(this, options);
